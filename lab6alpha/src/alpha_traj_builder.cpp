#include<lab6alpha/alpha_traj_builder.h>
...
AlphaTrajBuilder::AlphaTrajBuilder()  {
...
double AlphaTrajBuilder::min_dang(double dang) {
...
double AlphaTrajBuilder::sat(double x) {
    if (x > 1.0) {
        return 1.0;
    }
    if (x< -1.0) {
...
double AlphaTrajBuilder::sgn(double x) {
    if (x > 0.0) {
        return 1.0;
    }
    if (x< 0.0) {
...
double AlphaTrajBuilder::convertPlanarQuat2Psi(geometry_msgs::Quaternion quaternion) {
...
geometry_msgs::Quaternion AlphaTrajBuilder::convertPlanarPsi2Quaternion(double psi) {
...
geometry_msgs::PoseStamped AlphaTrajBuilder::xyPsi2PoseStamped(double x, double y, double psi) {
...
void AlphaTrajBuilder::build_trapezoidal_spin_traj(geometry_msgs::PoseStamped start_pose,
...
// profile is needed
void AlphaTrajBuilder::build_spin_traj(geometry_msgs::PoseStamped start_pose,
        geometry_msgs::PoseStamped end_pose,
        std::vector<nav_msgs::Odometry> &vec_of_states) {
...
void AlphaTrajBuilder::build_travel_traj(geometry_msgs::PoseStamped start_pose,
        geometry_msgs::PoseStamped end_pose,
        std::vector<nav_msgs::Odometry> &vec_of_states) {
    //decide if triangular or trapezoidal profile:
    double x_start = start_pose.pose.position.x;
...
void AlphaTrajBuilder::build_trapezoidal_travel_traj(geometry_msgs::PoseStamped start_pose,
        geometry_msgs::PoseStamped end_pose,
        std::vector<nav_msgs::Odometry> &vec_of_states) {
    double x_start = start_pose.pose.position.x;
    double y_start = start_pose.pose.position.y;
...
void AlphaTrajBuilder::build_triangular_travel_traj(geometry_msgs::PoseStamped start_pose,
        geometry_msgs::PoseStamped end_pose,
        std::vector<nav_msgs::Odometry> &vec_of_states) {
    double x_start = start_pose.pose.position.x;
    double y_start = start_pose.pose.position.y;
...
void AlphaTrajBuilder::build_triangular_spin_traj(geometry_msgs::PoseStamped start_pose,
        geometry_msgs::PoseStamped end_pose,
        std::vector<nav_msgs::Odometry> &vec_of_states) {
    nav_msgs::Odometry des_state;
    des_state.header = start_pose.header; //really, want to copy the frame_id
...
void AlphaTrajBuilder::build_braking_traj(geometry_msgs::PoseStamped start_pose,
        std::vector<nav_msgs::Odometry> &vec_of_states) {
    nav_msgs::Odometry des_state = vec_of_states.back();
    des_state.header = start_pose.header; //really, want to copy the frame_id
    ...
    double speed_des = des_state.twist.twist.linear.x;
    double psi_des = convertPlanarQuat2Psi(start_pose.pose.orientation);

    while (omega_des > 0 && speed_des > 0){
        if (omega_des > 0){
...
void AlphaTrajBuilder::build_point_and_go_traj(geometry_msgs::PoseStamped start_pose,
        geometry_msgs::PoseStamped end_pose,
        std::vector<nav_msgs::Odometry> &vec_of_states) {
