...
#include <queue>
#include <lab6alpha/alpha_traj_builder.h> //has almost all the headers we need
#include <std_msgs/Float64.h>
#include <std_msgs/Bool.h>
#include <std_srvs/Trigger.h>
#include <lab6alpha/path.h>
#include <std_msgs/Float64.h>
...
private:
    ...
    std::vector<nav_msgs::Odometry> des_state_vec_stop_;
    ...
    bool appendPathQueueCB(lab6alpha::pathRequest& request,lab6alpha::pathResponse& response);
