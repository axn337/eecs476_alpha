...
bool callback(lab3alpha::PathSrvRequest& request, lab3alpha::PathSrvResponse& response)
{
...
{
  ros::init(argc, argv, "alpha_path_service");
  ros::NodeHandle n;
  ...
  ros::ServiceServer service = n.advertiseService("alpha_path_service", callback);
