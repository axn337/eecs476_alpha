...
AlphaDesStatePublisher::AlphaDesStatePublisher(ros::NodeHandle& nh) : nh_(nh) {
    //as_(nh, "pub_des_state_server", boost::bind(&AlphaDesStatePublisher::executeCB, this, _1),false) {
...
void AlphaDesStatePublisher::initializeServices() {
    ROS_INFO("Initializing Services");
    estop_service_ = nh_.advertiseService("estop_service",
            &AlphaDesStatePublisher::estopServiceCallback, this);
    estop_clear_service_ = nh_.advertiseService("clear_estop_service",
            &AlphaDesStatePublisher::clearEstopServiceCallback, this);
...
void AlphaDesStatePublisher::initializePublishers() {
...
void AlphaDesStatePublisher::alarmCB(const std_msgs::Bool& alarm_msg) 
{ 
...
void AlphaDesStatePublisher::estopCB(const std_msgs::Bool& estop_msg) 
{ 
...
bool AlphaDesStatePublisher::flushPathQueueCB(std_srvs::TriggerRequest& request, std_srvs::TriggerResponse& response) {
...
void AlphaDesStatePublisher::set_init_pose(double x, double y, double psi) {
